...
class Github_updater
{
    ...
    public function update()
    {
        ...
        if ($hash !== $this->ci->config->item('current_commit')) {
            ...
            if ($dir = $this->_get_and_extract($hash)) {
                ...
                // Update the samrd version in the config filename
    ...
    */
    ...
    /**
    * Get samrd current version.
    *
    * @return string Samrd current version.
    */
    private function getCurrentVersion()
    {
        ...
        if (!$version) {
            throw new Exception('Error getting samrd version from GitHub!');
        }
