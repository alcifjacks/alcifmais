...
class Migration_create_base extends CI_Migration
{
    public function up()
    {
        ...
        $this->dbforge->add_key("idDevedores", true);
        $this->dbforge->create_table("devedores", true);
        $this->db->query('ALTER TABLE  `devedores` ENGINE = InnoDB');
        ...
        $this->db->query('ALTER TABLE  `lancamentos` ADD INDEX `fk_lancamentos_devedores1` (`devedores_id` ASC)');
        ...
        $this->db->query('ALTER TABLE  `lancamentos` ADD CONSTRAINT `fk_lancamentos_devedores1`
        ...
        $this->db->query('ALTER TABLE  `os` ADD INDEX `fk_os_devedores1` (`devedores_id` ASC)');
        ...
        $this->db->query('ALTER TABLE  `os` ADD CONSTRAINT `fk_os_devedores1`
			FOREIGN KEY (`devedores_id`)
			REFERENCES `devedores` (`idDevedores`)
			ON DELETE NO ACTION
			ON UPDATE NO ACTION
        ...
        $this->db->query('ALTER TABLE  `vendas` ADD INDEX `fk_vendas_devedores1` (`devedores_id` ASC)');
        ...
        $this->db->query('ALTER TABLE  `vendas` ADD CONSTRAINT `fk_vendas_devedores1`
			FOREIGN KEY (`devedores_id`)
			REFERENCES `devedores` (`idDevedores`)
			ON DELETE NO ACTION
			ON UPDATE NO ACTION
        ...
        $this->db->query('ALTER TABLE  `equipamentos` ADD INDEX `fk_equipanentos_devedores1_idx` (`devedores_id` ASC)');
        $this->db->query('ALTER TABLE  `equipamentos` ADD CONSTRAINT `fk_equipanentos_marcas1`
			...
			ON UPDATE NO ACTION
		');
        $this->db->query('ALTER TABLE  `equipamentos` ADD CONSTRAINT `fk_equipanentos_devedores1`
			FOREIGN KEY (`devedores_id`)
			REFERENCES `devedores` (`idDevedores`)
			ON DELETE NO ACTION
			ON UPDATE NO ACTION
    ...
    public function down()
    {
        ...
        ### Drop table devedores ##
        $this->dbforge->drop_table("devedores", true);
