<div class="widget-box">
    <div class="widget-title">
        <ul class="nav nav-tabs">
            <li class="active"><a data-toggle="tab" href="#tab1">Dados do Devedor</a></li>
            <li><a data-toggle="tab" href="#tab2">Ordens de Serviço</a></li>
            <div class="buttons">
                <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'eDevedor')) {
    echo '<a title="Icon Title" class="btn btn-mini btn-info" href="' . base_url() . 'index.php/devedores/editar/' . $result->idDevedores . '"><i class="fas fa-edit"></i> Editar</a>';
} ?>
                <a title="Voltar" class="btn btn-mini btn-inverse" href="<?php echo site_url() ?>/devedores"><i class="fas fa-arrow-left"></i> Voltar</a>
            </div>
        </ul>
    </div>
                    ...
                    <div class="collapse in accordion-body" id="collapseGOne">
                        <div class="widget-content">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <td style="text-align: right"><strong>Tipo do Devedor</strong></td>
                                    <td>
                                        <?php echo $result->fornecedor == true ? 'Fornecedor' : 'Devedor'; ?>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
