    ...
    <div class="span12">
        <div class="widget-box">
            ...
            <div class="widget-content">
                ...
                <?php if ($custom_error) { ?>
                    <div class="span12 alert alert-danger" id="divInfo" style="padding: 1%;">Dados incompletos, verifique os campos com asterisco ou se selecionou corretamente devedor e responsável.</div>
                <?php  } ?>
...
<script type="text/javascript">
    $(document).ready(function() {
        $("#devedor").autocomplete({
            source: "<?php echo base_url(); ?>index.php/garantias/autoCompleteDevedor",
            minLength: 1,
            select: function(event, ui) {
                $("#devedores_id").val(ui.item.id);
            }
        });
