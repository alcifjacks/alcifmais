                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select name="per_page" id="theme">
                                    ...
                                    <option value="1000000" <?= $configuration['per_page'] == '1000000' ? 'selected' : ''; ?> >Ilimitado</option>
                                </select>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select name="os_notification" id="os_notification">
                                    ...
                                    <option value="devedor" <?= $configuration['os_notification'] == 'devedor' ? 'selected' : ''; ?> >Somente o Devedor</option>
                        ...
                        <div class="control-group">
                            ...
                            <div class="span3">
                                ...
                                <select class="span12" name="notifica_whats_select" id="notifica_whats_select" value="">
                                    ...
                                    <option value="{CLIENTE_NOME}">Nome do Devedor</option>
                        ...
                        <div class="form-actions">
                            <div class="span8">
                                <div class="span9">
                                    ...
                                    <button href="#modal-confirmaratualiza" data-toggle="modal" type="button" class="btn btn-danger"><i class="fas fa-sync-alt"></i> Atualizar Samrd</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
<div id="modal-confirmaratualiza" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <form action="<?php echo base_url() ?>index.php/devedores/excluir" method="post">
        ...
        <div class="modal-footer">
            ...
            <button id="update-samrd" type="button" class="btn btn-danger"><i class="fas fa-sync-alt"></i>Atualizar</button>
        </div>
    </form>
</div>
<!-- Modal -->
    ...
    <form action="<?php echo base_url() ?>index.php/devedores/excluir" method="post">
        ...
        <div class="modal-body">
            ...
            <h7 style="text-align: left">Recomendamos que faça um backup antes de prosseguir!
                <a target="_blank" title="Fazer Bakup" class="btn btn-mini btn-inverse" href="<?php echo site_url() ?>/samrd/backup">Fazer Backup</a>
            </h7>
        </div>
        <div class="modal-footer">
            <button class="btn" data-dismiss="modal" aria-hidden="true">Cancelar</button>
...
<script>
    $('#update-database').click(function () {
        window.location = "<?= site_url('samrd/atualizarBanco') ?>"
    });
    $('#update-samrd').click(function() {
        window.location = "<?= site_url('samrd/atualizarSamrd') ?>"
    });
