...
<div class="row-fluid" style="margin-top:0">
    <div class="span12">
        <div class="widget-box">
            ...
            <i class="fas fa-user"></i>
                ...
                <h5>Editar Devedor</h5>
                <div class="buttons">
                    <a title="Voltar" class="btn btn-mini btn-inverse" href="<?php echo site_url() ?>/devedores"><i
            ...
            <form action="<?php echo current_url(); ?>" id="formDevedor" method="post" class="form-horizontal">
    ...
    echo '<div class="alert alert-danger">' . $custom_error . '</div>';
                    ...
                    <div id="home" class="tab-pane fade in active">
                        ...
                        <div class="control-group">
                            <?php echo form_hidden('idDevedores', $result->idDevedores) ?>
                            <label for="nomeDevedor" class="control-label">Nome/Razão Social<span
                                        class="required">*</span></label>
                            <div class="controls">
                                <input id="nomeDevedor" type="text" name="nomeDevedor"
                                       value="<?php echo $result->nomeDevedor; ?>"/>
                            </div>
                        </div>
                        <div class="control-group">
                            <label for="contato" class="control-label">Contato:</label>
                            <div class="controls">
                                <input class="nomeDevedor" type="text" name="contato"
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input id="celular" type="tel" name="celular" value="<?php echo $result->celular; ?>"/>
                            </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                            <label class="control-label">Tipo de Devedor</label>
                            <div class="controls">
