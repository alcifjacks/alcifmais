            ...
            <div class="widget-content">
                <form target="_blank" action="<?php echo base_url() ?>index.php/relatorios/skuCustom" method="get">
                    ...
                    <div class="span12 well" style="margin-left: 0">
                        ...
                        <input class="span12" id="devedor" type="text" name="devedor" />
                        <input type="hidden" name="devedores_id" id="devedores_id">
                    </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#devedor").autocomplete({
            source: "<?php echo base_url(); ?>index.php/os/autoCompleteDevedor",
            minLength: 2,
